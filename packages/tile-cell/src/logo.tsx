...
export function Logo({
	...
	/**
	 * The accessible name of the mark, required where nothing beside the logo names the app; decorative if omitted or
	 * empty, as it is wherever the app name is already on show beside it.
	 */
	name?: string
